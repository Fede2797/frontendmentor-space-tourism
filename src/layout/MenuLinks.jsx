...
export const MenuLinks = ({currentSection}) => {
  return (
    <div className="hidden md:flex w-[58vw] h-full bg-white mr-[-24px] backdrop-blur-2xl bg-opacity-5 text-white gap-[10%] uppercase font-barlowcondensed tracking-[2.3625px] text-sm px-[10%] lg:text-base">
