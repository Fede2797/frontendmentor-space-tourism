...
export const CrewTest = () => {
  ...
  return (
    <CrewLayout>
        {/* Main container */}
        <div className="grid grid-cols-1 text-white justify-center lg:grid-cols-2 lg:auto-rows-min lg:grid-rows-3 lg:pl-[10%] lg:h-full
        lg:max-h-[750px] lg:max-w-[1500px] 2xl:mx-auto 2xl:w-[1500px]">
          ...
          md:order-1 md:justify-self-start md:pl-4 md:mb-[60px] md:tracking-[3.38px] md:text-xl
          ...
          <div className="flex w-full justify-center md:order-4 lg:order-2 lg:row-span-3">
            <img 
              ...
              ${ currentMember.name === 'Douglas Hurley' ? 'md:max-h-[572px]' : 'md:max-h-[548px]'} 
              lg:max-w-full lg:max-h-none lg:mt-auto`} src={currentMember.images.webp} alt="" 
            />
          </div>
          ...
          {/* Member info */}
          <div className="text-center md:order-2 md:max-w-[63%] md:justify-self-center lg:text-left lg:max-w-none
