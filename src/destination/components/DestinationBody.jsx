...
export const DestinationBody = ({currentDestination}) => {
  return (
    <>
        <h1 className="font-bellefair text-[56px] uppercase leading-[64px] md:text-[80px] md:mb-2 md:leading-[92px] lg:text-[100px] lg:leading-[115px]">{ currentDestination.name }</h1>
        {/* Destination description */}
        <p className="max-w-[570px] font-barlow text-[15px] leading-[25px] text-light-blueish md:w-[79%] md:max-w-full md:text-base lg:max-w-none lg:w-full lg:text-left lg:text-lg lg:leading-8">
